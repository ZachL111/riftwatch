"""Regression checks for the riftwatch casebook."""
...
from casebook.harness import assert_expected, riftwatch_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(riftwatch_summary(), assert_expected())
