...
riftwatch is a R project for ml utilities. It focuses on this technical goal: Detect time-series anomalies using rolling medians and explainable thresholds.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 152, risk penalty 7, latency penalty 3, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
