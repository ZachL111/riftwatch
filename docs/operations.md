...
`riftwatch` is centered on ml utilities work in R. The technical target is: Detect time-series anomalies using rolling medians and explainable thresholds.
...
The score is deterministic. The current threshold is 152. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 4.
